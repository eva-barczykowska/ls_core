...
# p swap_letters("Ewa")
#
# def swap(str, swap_letters(word))
#   result = []
#   if str.size == 1
#     str
#   else str.size < 1
#     str.split.each do |word|
#       result << word.swap_letters(word)
#     end
#   end
#     result.join
# end
...
def running_total(array)
  ...
  if array.empty?
    ...
    while counter < (array.size - 1)
      result << result[counter] + array[counter + 1] #why last is 18, coz 13+5
      counter += 1
  end
end
  result
...
# #index assignement is mutating with respect to the array object, replaces the elment, mutats the state of the array obj
...
#   char.upcase # is the elem affected or the other array? here we are mutating the state of the outer array
# end
...
#
# Algorithm
#keep consinstent WHAT you are returning =================================================================
# -define the result array
# -check if the argument array is empty and if yes, return that array
# -check if the argument array contains only 1 element and if yes, return that same array
# -else process the array, this is how
...
###############################################################################################
puts "pasted content of the session"
# n = 10
