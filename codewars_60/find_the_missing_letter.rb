...
def find_missing_letter(array)
  ...
  if array.first == array.first.downcase
    result = should_have_lower - array
  else
    result = should_have_lower.map(&:upcase) - array
  end
...
def find_missing_letter(arr)
  ...
  # (arr.first..arr.last).to_a                 # whaaaaaaaaaaaaaaaaat?! # didn't think you could do this!
end
