...
puts
arr = [[3, 2, 3]] * 3 # [[3, 2, 3], [3, 2, 3], [3, 2, 3]] but each array in the result array is POINTING TO THE SAME OBJECT
p arr

puts
arr.each do |s|
  s << 100 #each time we iterate, we append to EACH OF THE ARRAYS 100 (because each of the arrays pointing to the same object)
  p arr
end
