...
# Problem
# =======
# -method takes an array of integers as an argumenent
# -method returns min sum of 5 consecutive numbers in the array
# -if the array contains fewer than 5 numbers, method returns nil
# -only numbers are elements, positive or negative
#
# Examples
# =========
# p minimum_sum([1, 2, 3, 4]) == nil
...
# p minimum_sum([1, 2, 3, 4, 5, -5]) == 9
# => 5 consecutive number will be:
# [1, 2, 3, 4, 5] => 15
# [2, 3, 4, 5, -5] => 9 MIN SUM
# p minimum_sum([1, 2, 3, 4, 5, 6]) == 15
# [1, 2, 3, 4, 5] => 15 MIN SUM
# [2, 3, 4, 5, 6] => 20
# p minimum_sum([55, 2, 6, 5, 1, 2, 9, 3, 5, 100]) == 16
# [55, 2, 6, 5, 1] => 69
# [2, 6, 5, 1, 2] => 16 MIN SUM
# [6, 5, 1, 2, 9] => 23
# [5, 1, 2, 9, 3] => 20
# [1, 2, 9, 3, 5] => 20
# p minimum_sum([-1, -5, -3, 0, -1, 2, -4]) == -10
# [-1, -5, -3, 0, -1] => - 10 MIN SUM
# [-5, -3, 0, -1, 2] => 7
# [-3, 0, -1, 2, -4] => 6
#
# Algorithm
# =========
# INIT `slices` array
# CREATE arrays of 5 elements from the array argument
# --start at index 0 and continue to index -5 -starting index
# --start at starting index and continue to the end of the array - ending index
# --slice elements at target indices, store slice in `slices` array
#
# TRANSFORM slices into their sum
# RETURN mininum sum
